...
public class TrainTicket {
    public static void main(String[] args) {
        ...
        System.out.println("Prezzo totale Biglietto: €" + totalTripPrice);
        ...
        if (userAge < 18 ){
            ...
            System.out.println("prezzo scontato under 18: " + discountedPrice);

        } else if (userAge >= 65 ) {
            // // //
            double discount = (totalTripPrice * 40) / 100;
            double discountedPrice = totalTripPrice - discount;
            System.out.println("prezzo scontato over 65: " + discountedPrice);
